...
<head>
    ...
    if (isset($article) && isset($article['description'])) {
        echo $article['description'];
    } elseif (isset($article) && isset($article['summary'])) {
        echo $article['summary'];
    } elseif (isset($article) && isset($article['title'])) {
        echo $article['title'];
    } else {
    ...
    <meta property="og:title" content="{{ isset($article) && isset($article['title']) ? $article['title'] : '齐尔克泽向曼联提离队申请 罗马希望3000万签他' }}" />
    ...
    if (isset($article) && isset($article['description'])) {
        ...
        echo '齐尔克泽向曼联提离队申请 罗马希望3000万签他';
    }
    @endphp" />
    <meta property="og:url" content="https://{{ request()->getHost() }}{{ request()->getPathInfo() }}" />
    @if(isset($article) && isset($article['image']))
    <meta property="og:image" content="@php echo $article['image']; @endphp" />
    @endif
    <meta property="article:published_time" content="{{ isset($article) && isset($article['publishTime']) ? $article['publishTime'] : '2025-12-28T12:00:00+08:00' }}" />
    <meta property="article:author" content="{{ isset($article) && isset($article['source']['name']) ? $article['source']['name'] : '体育资讯' }}" />
    ...
    <link href="/detail/static/css/tipbj.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/detail/static/js/jquery.js"></script>
    <script type="text/javascript" src="/detail/static/js/header.js"></script>
    <script type="text/javascript" src="/detail/static/js/search.js"></script>
    ...
    @php
        $jsonLdArticle = [
            ...
            "@type" => "NewsArticle",
            "headline" => isset($article) && isset($article['title']) ? $article['title'] : "齐尔克泽向曼联提离队申请 罗马希望3000万签他",
            "description" => isset($article) && isset($article['description']) ? $article['description'] : (isset($article) && isset($article['summary']) ? $article['summary'] : "齐尔克泽向曼联提离队申请"),
            "image" => [
                "@type" => "ImageObject",
                "url" => isset($article) && isset($article['image']) ? $article['image'] : "/detail/static/picture/default.jpg"
            ],
            ...
            "mainEntityOfPage" => [
                "@type" => "WebPage",
                "@id" => "https://" . request()->getHost() . request()->getPathInfo()
            ]
        ];
    @endphp
...
<body oncontextmenu="return false" onselectstart="return false" oncopy="return false">
    <script type="text/javascript" src="/detail/static/js/acpl.js"></script>
    <script type="text/javascript" src="/detail/static/js/os_hidden_flag.js"></script>

    <div class="t_bg_t">
        <div class="header">
            <div class="t_menu">
                <div style="float:left; margin-left:10px;">
                    <a href="{{ domain('main') }}" class="white_lnk12">7M首页</a>
                </div>
            </div>
            <div class="m_menu">
        ...
        <div class="n_t">
            <div class="n_tz">
                ...
                @php
                    $breadcrumbItems = [
                        ...
                        [
                            "@type" => "ListItem",
                            "position" => 2,
                            "name" => isset($category) ? $category : '国际足球',
                            "item" => "https://" . request()->getHost() . "/category/" . (isset($category) ? $category : 'international')
                        ],
                        [
                            "@type" => "ListItem",
                            "position" => 3,
                            "name" => isset($subcategory) ? $subcategory : '英超',
                            "item" => "https://" . request()->getHost() . "/subcategory/" . (isset($subcategory) ? $subcategory : 'premier')
                        ]
                    ];
                    $breadcrumbSchema = [
                        "@context" => "https://schema.org",
                ...
                <div class="ny_zw">
                    ...
                    @if(isset($article) && $article)
                        ...
                        <div class="zw">
                            @if(isset($article['image']) && $article['image'])
                                ...
                                <br />
                            @endif
                            @if(isset($article['contentParagraphs']) && is_array($article['contentParagraphs']))
                                @foreach($article['contentParagraphs'] as $paragraph)
                                    {{ $paragraph }}<br />
                                    <br />
                                @endforeach
                            @elseif(isset($article['summary']))
                                {{ $article['summary'] }}
                            @else
                                　　意大利足球记者埃莱奥诺拉·特罗塔透露，齐尔克泽已经向曼联提出离队申请。<br />
                                <br />
                                　　埃莱奥诺拉·特罗塔表示："在过去两个多月时间，齐尔克泽都被确认是罗马的首选锋线引援目标。这名荷兰前锋已经向曼联提出了离队申请，目前正在等待俱乐部的答复。转会总价约3000万欧元，包括租借和强制买断费用。"<br />
                                <br />
                                　　齐尔克泽本赛季在曼联只出场9次并打进1球，他希望回到自己成名的意甲联赛，为明年世界杯的参赛资格做最后一搏。而罗马也需要在冬季引进一名新前锋，补强进攻不力的短板，罗马体育总监马萨拉此前已经和齐尔克泽的经纪人进行过会谈。
                            @endif
                        </div>
                    @else
                        <div class="zw_bt">
                        ...
                        <div class="zw">
                            <p align="center">
                                <img border="0" alt="" src="/detail/static/picture/20251213101314_91817.jpg" /></p>
                            <br />
                            　　意大利足球记者埃莱奥诺拉·特罗塔透露，齐尔克泽已经向曼联提出离队申请。<br />
                            <br />
                            　　埃莱奥诺拉·特罗塔表示："在过去两个多月时间，齐尔克泽都被确认是罗马的首选锋线引援目标。这名荷兰前锋已经向曼联提出了离队申请，目前正在等待俱乐部的答复。转会总价约3000万欧元，包括租借和强制买断费用。"<br />
                    ...
                    <div class="ny_tbox">
                        <p class="bc" style="display:;">更多关于"
                            <a href="https://www.baidu.com/s?wd=%E9%BD%90%E5%B0%94%E5%85%8B%E6%B3%BD+site%3Anews.7m.com.cn" target="_blank">齐尔克泽</a>
                            <a href="https://www.baidu.com/s?wd=%E6%9B%BC%E8%81%94+site%3Anews.7m.com.cn" target="_blank">曼联</a>
                            <a href="https://www.baidu.com/s?wd=%E7%BD%97%E9%A9%AC+site%3Anews.7m.com.cn" target="_blank">罗马</a>"的新闻
                        </p>
                        <div class="clear"></div>
                    ...
                    <h2 class="ny_b">相关新闻</h2>
                    <!-- Start Content ny_xg -->	
                    {!! load_content('ny_xg.txt', true) !!}
                    <!-- End Content ny_xg -->	
                    <div class="clear"></div>
                    <h2 class="ny_b">曼彻斯特联动态</h2>
                    <div class="ny_xg">
    ...
    <div class="bottom">
        <div class="bottom_a">
            <a href="javascript:" onclick="window.open('{{ domain_url('help', 'sm_gb.htm') }}','','width=560,height=260,scrollbars=yes');">本站声明</a>|

            <a href="javascript:" onclick="window.open('{{ domain_url('help', 'jump.aspx?l=gb&page=sentmessage&t=0') }}','','width=450,height=528,scrollbars=yes');">联系我们</a>|

            <a href="javascript:" onclick="window.open('{{ domain_url('help', 'jump.aspx?l=gb&page=sentmessage&t=1') }}','','width=450,height=528,scrollbars=yes');">报告错误</a>|
        ...
        <p>提醒：第三方机构可能在7M体育宣传他们的产品或服务，7M体育将不保证其宣传信息的准确。
            ...
            <br />Copyright © 2003 - <script language="javascript">
                document.write((new Date()).getFullYear());
            </script> 版权所有 www.7m.com.cn All Rights Reserved. 保留全部权利.
        </p>
    ...
    <div style="position:absolute;display:none; width:300px; height:100px;filter:alpha(opacity=80); opacity: 0.8;z-index:999;" id="divTip" onmouseover="clearTimeout(timer);this.style.display=''" onmouseout="timer=setTimeout('hideTip()',1000)">
        ...
        <div id="tipbg1">
            ...
            <a target="_blank" id="a2" style="background: url(/detail/static/images/sicon1.gif) no-repeat left;padding-left: 20px;">搜索百度关于<font style="color:#FF0000;font-weight:bold" id="f2"></font>的新闻</a><br />
            <a target="_blank" id="a3" style="background: url(/detail/static/images/sicon2.gif) no-repeat left;padding-left: 20px;">搜索Google关于<font style="color:#FF0000;font-weight:bold" id="f3"></font>的新闻</a>
        </div>
        <div id="tipbj2"></div>
    </div>
    <script type="text/javascript" src="/detail/static/js/newstip.js"></script>
    <div style="display:none">
        <script type="text/javascript" src="/detail/static/js/count.js"></script>
        <script>
            ...
            if (loc.indexOf("/news/") != -1) {
                ...
                if (regMatch != null) {
                    document.write('<script type="text/javascript" src="/detail/static/js/count.js' + regMatch[1] + '"><\/script>');
                }
            }
            //推介
    ...
    <script type="text/javascript">
        ...
        @php
            // Extract article ID
            $articleId = '710168';
            if (isset($article) && isset($article['articleId'])) {
                $articleId = $article['articleId'];
            } elseif (isset($article) && isset($article['id'])) {
                // Extract number from id like "art_20251213_710116" -> "710116"
                if (preg_match('/(\d+)$/', $article['id'], $matches)) {
                    $articleId = $matches[1];
                }
            }

            // Get NewsUrl
            $newsUrl = '/Article/details/' . $articleId . '.shtml';
            if (isset($article) && isset($article['canonicalUrl'])) {
                // Extract path from canonicalUrl
                $parsed = parse_url($article['canonicalUrl']);
            ...
            // Get NewsTitle
            $newsTitle = '齐尔克泽向曼联提离队申请 罗马希望3000万签他';
            if (isset($article) && isset($article['title'])) {
                $newsTitle = addslashes($article['title']);
            }

            // Get NewsContent (from description or summary, truncated to ~150 chars)
            $newsContent = '意大利足球记者埃莱奥诺拉·特罗塔透露，齐尔克泽已经向曼联提出离队申请。埃莱奥诺拉·特罗塔表示："在过去两个多月时间，齐尔克泽都被确认是罗马的首选锋线引援目标。这名荷兰前锋已 …… 详细:';
            if (isset($article)) {
                $content = '';
                ...
                } elseif (isset($article['contentParagraphs']) && is_array($article['contentParagraphs']) && !empty($article['contentParagraphs'])) {
                    $content = $article['contentParagraphs'][0];
                }
                ...
                if ($content) {
                    ...
                    $newsContent = addslashes($content) . ' …… 详细:';
                }
            }
        @endphp
        var __ud = {{ json_encode($articleId) }};
        var NewsUrl = {{ json_encode($newsUrl) }};
        var NewsTitle = {{ json_encode($newsTitle) }};
        var NewsContent = {{ json_encode($newsContent) }};
        var NewsPic;
        ...
        function share_to(type) {
            ...
            switch (type) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    share_to_url = '//cang.baidu.com/do/add?it=' + NewsTitle + '&iu=' + NewsUrl + '&dc=' + NewsContent + webNewsUrl + '&tn=推荐,推荐,7M足球';
                    break;
                case 7:
        ...
        var bds_config = {
            'bdText': NewsTitle + String.fromCharCode(13) + NewsContent
        };
        document.getElementById("bdshell_js").src = "//bdimg.share.baidu.com//detail/static/js/shell_v2.js?cdnversion=" + new Date().getHours();
        //]]>
    </script>
</body>

</html>
<script type="text/javascript" language="javascript" src="/detail/static/js/addmessagediv.js"
